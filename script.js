document.addEventListener("DOMContentLoaded", () => {
    const chatbotHTML = `
       <style>
        ...
        <div id="bot-icon">
            <svg t="1733665227834" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5148" width="50" height="50">
    ...
    const rules = [
        ...
        */
        ...
        { input: "promociones", answer: "Por el mes de navidad tenemos promociones del 20% de descuento en compras mayores a 100Bs.", type: 0 },
        ...
        */
        ...
        { input: "", answer: "promociones", type: 1 },
    ];
